...
@app.route('/success')
def success():
    return render_template('success.html', current_page='success')

@app.route('/testimonial')
def testimonial():
    return render_template('testimonial.html', current_page='testimonial')

@app.route('/weather_forecaster', methods=['GET', 'POST'])
def weather_forecaster():
    ...
    return render_template('weather_forecaster.html', form=form)
